            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-2 space-x-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                {{ $product['status']['value'] ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                {{ $product['status']['label'] ?? 'Not approved' }}
                            </span>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                {{ $product['is_approve']['value'] ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800' }}">
                    ...
                    <div class="mt-4 md:mt-0">
                        ...
                        <div class="font-medium text-gray-900">{{ $product['vendor']['name'] }}</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900 mt-1">{{ $product['approved']['name'] ?? 'Not approved' }}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="bg-white shadow overflow-hidden rounded-lg">
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <dl class="grid grid-cols-2 gap-x-4 gap-y-3">
                                                <div class="col-span-1">
                                                    ...
                                                    <dd class="mt-1 text-sm text-gray-900">{{ $subProduct['size_type'] }}</dd>
                                                </div>
                                                <div class="col-span-1">
                                                    <dt class="text-sm font-medium text-gray-500">Size</dt>
                                                    <dd class="mt-1 text-sm text-gray-900">{{ $subProduct['size'] }}</dd>
                                                </div>
                                                <div class="col-span-1">
                                                    <dt class="text-sm font-medium text-gray-500">Price</dt>
                                                    <dd class="mt-1 text-sm text-gray-900">${{ number_format($subProduct['price'], 2) }}</dd>
                                                </div>
                                                <div class="col-span-1">
                                                    <dt class="text-sm font-medium text-gray-500">Base Price</dt>
                                                    <dd class="mt-1 text-sm text-gray-900">${{ number_format($subProduct['base_price'], 2) }}</dd>
                                                </div>
                                                <div class="col-span-1">
                                                    <dt class="text-sm font-medium text-gray-500">Quantity</dt>
                                                    <dd class="mt-1 text-sm text-gray-900">{{ $subProduct['quantity'] }}</dd>
                                                </div>
                                            </dl>
                                        </div>
                                        ...
                                        <div>
                                            <h5 class="text-sm font-medium text-gray-500 mb-2">Specifications</h5>
                                            <ul class="text-sm text-gray-700 space-y-1">
                                                @foreach($subProduct['specifications'] as $spec)
                                                <li class="flex">
                                                    <span class="font-medium text-gray-900 w-32 truncate">{{ $spec['name'] }}:</span> 
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                                            ...
                                            <div class="group relative rounded-md overflow-hidden border border-gray-200">
